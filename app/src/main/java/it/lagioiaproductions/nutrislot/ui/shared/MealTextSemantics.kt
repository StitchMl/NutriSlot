...
internal fun protectConnectedMealPhrases(text: String): String {
    var result = text
...
internal fun restoreConnectedMealPhrases(text: String): String {
    var result = text
    PROTECTED_MEAL_PHRASES.forEachIndexed { index, phrase ->
...
internal fun shouldAppendMealContinuation(
    previous: String,
    current: String
): Boolean {
